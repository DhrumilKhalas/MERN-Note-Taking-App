...
const MyNotes = ({ search }) => {
  ...
  const { success: updateSuccess } = useSelector(
    (state) => state.isNoteUpdated
  );
  const {
    status: deleteStatus,
    isError: deleteError,
    success: deleteSuccess,
  } = useSelector((state) => state.isNoteDeleted);
